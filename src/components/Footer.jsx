  ...
  return (
    <footer className='text-right bg-purple rounded-t-[40px] lg:h-[443px] pb-[24px] pt-[48px]'>
      ...
      <div className='mb-[24px]'>
        <img src="/src/assets/images/Footer.svg" alt="Footer" className='w-[296px] lg:w-full mb-[18.35px]'/>
       ...
       <ul>
         ...
         <li className='pb-[16px]'><a href="#" className='flex items-center gap-[12px]'><img src="/src/assets/icon/telephone.svg" alt="telephone" className='w-[24px]' /><span className='font-normal text-[20px] lg:text-[24px] leading-[38.4px] text-greenlight'>00967770536980</span></a></li>
         <li className='pb-[16px]'><a href="#" className='flex items-center gap-[12px]'><img src="/src/assets/icon/mail.svg" alt="mail" /><span className='font-normal text-[20px] lg:text-[24px] leading-[38.4px] text-greenlight'>asem73739@gmail.com</span></a></li>
         <li><a href="#" className='flex items-center gap-[12px]'><img src="/src/assets/icon/facebookfooter.svg" alt="facebookfooter" /><span className='font-normal text-[20px] lg:text-[24px] leading-[38.4px] text-greenlight'>كويكلي للخدمات الاكاديمية</span></a></li>
       </ul>
      </div>
